...
// in simulator we redefine to format for Jester Developer console
...
{\
	NSString * exceptionName = [@"org.jester." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.jester";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIJesterNativeItemNone = -1, 
	UIJesterNativeItemSpinner = -2,
	UIJesterNativeItemProgressBar = -3,
	
	UIJesterNativeItemSlider = -4,
	UIJesterNativeItemSwitch = -5,
	UIJesterNativeItemMultiButton = -6,
	UIJesterNativeItemSegmented = -7,
	
	UIJesterNativeItemTextView = -8,
	UIJesterNativeItemTextField = -9,
	UIJesterNativeItemSearchBar = -10,
	
	UIJesterNativeItemPicker = -11,
	UIJesterNativeItemDatePicker = -12,
	
	UIJesterNativeItemInfoLight = -13,
	UIJesterNativeItemInfoDark = -14,
	
	UIJesterNativeItemDisclosure = -15,
	
	UIJesterNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Jester instances of
