...
/**
 The base class for all Jester modules
 */
...
/**
 Jester Platform calls this method on startup.
 */
-(void)startup;

/**
 Jester Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Jester Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Jester Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Jester Platform calls this method on resume.
 @param sender The sender of the event.
 */
